...
module.exports = class UCPStream extends streamx.Duplex {
  ...
  get rtt () {
    return this._view[binding.offsetof_ucp_stream_t_srtt >> 2]
  }

  get cwnd () {
    return this._view[binding.offsetof_ucp_stream_t_cwnd >> 2]
  }

  get inflight () {
    return this._view[binding.offsetof_ucp_stream_t_inflight >> 2]
  }

  setInteractive (bool) {
    if (!this._handle) return
    binding.ucp_napi_stream_set_mode(this._handle, bool ? 0 : 1)
  }
